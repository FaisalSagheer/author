    ...
    <>
      <section className="max-w-2xl lg:max-w-7xl mx-auto py-10 px-4 lg:px-10">
        ...
        {TourCards.map(
          (item, key) => (
            <div
              className="border-b border-gray-200 flex justify-between py-10"
              key={key}
            >
              <div className="flex flex-wrap lg:flex-nowrap justify-between items-center">
                <div className="mx-auto">
                  <img
                    src={item.src}
                    alt={item.src}
                    className="w-80 lg:w-60 lg:h-50"
                  />
                </div>
              ...
              <div className="lg:pt-20">
                <h3 className="flex justify-end text-xl">Nov</h3>
