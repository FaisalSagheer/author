...
export default function NewsLetter() {
    return (
        <>
            <section className='mx-auto text-center max-w-7xl py-10'>
                <div>
                    <h2 className='text-5xl max-w-4xl mx-auto font-medium'>Sign up for the NewsLetter for {" "}
                        updates on writing, tours, and more.
                    </h2>
                    <p className='text-xl max-w-2xl text-gray-500 mx-auto py-10'>
                        David Sedaris is the bestselling author of the books Calypso, Theft By Finding,
                        Let's Explore Diabete's with Owls, Squirls Seeks etc.
                    </p>
