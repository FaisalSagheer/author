          ...
          <div className="relative h-80 lg:mt-0 mb-30 lg:mb-0">
            {HeroItems.map((item, key) => (
              <img
                ...
                //   width={1800}
                //   height={1080}
                className="relative left-0 lg:left-15 mx-auto -bottom-11 lg:bottom-47 lg:w-[40rem] w-[26rem] max-w-none rounded-md"
              />
            ))}
          </div>
        </div>
